...
async function getallInvetory(req, res) {
    try {
        console.log("getAll");
        const inventary = await inventoryModel.find();
...
async function updateInventory(req, res) {
    ...
    const instituteId = req.params.id; // ID del instituto a actualizar
    ...
    const filter = {
        ...
        _id: instituteId, // Filtrar por ID del instituto
    };
    ...
    try {
        const updatedInstitute = await instituteModel.findOneAndUpdate(filter, update, { new: true });
